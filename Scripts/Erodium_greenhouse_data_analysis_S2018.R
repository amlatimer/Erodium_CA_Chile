...
# Set how close models have to be to the best model to be included in the importance values (in units of AIC points)
AIC_diff <- 4
...
imp = importance(subset(d2f_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
...
#plot(sl_ms1)
imp = importance(subset(sl_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
df = data.frame(variable=names(imp), impvalue=matrix(imp))
...
#plot(SLA_ms1)
imp = importance(subset(SLA_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
df = data.frame(variable=names(imp), impvalue=matrix(imp))
...
#plot(leafarea_ms1)
imp = importance(subset(leafarea_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
df = data.frame(variable=names(imp), impvalue=matrix(imp))
...
imp = importance(subset(d2f_wp_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
df = data.frame(variable=names(imp), impvalue=matrix(imp))
barplot(df$impvalue, names.arg=df$variable, las=2, ylab="Importance", cex.axis=1.3, cex.lab=axlab, cex.names = axtitle, main="Flowering time", ylim=c(0,1))
#'Best' model
...
#plot(sl_wp_ms1)
imp = importance(subset(sl_wp_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
df = data.frame(variable=names(imp), impvalue=matrix(imp))
barplot(df$impvalue, names.arg=df$variable, las=2, ylab="Importance", cex.axis=1.3, cex.lab=axlab, cex.names = axtitle, main="Stem length", ylim=c(0,1))
...
#plot(SLA_wp_ms1)
imp = importance(subset(SLA_wp_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
df = data.frame(variable=names(imp), impvalue=matrix(imp))
barplot(df$impvalue, names.arg=df$variable, las=2, ylab="Importance", cex.axis=1.3, cex.lab=axlab, cex.names = axtitle, main="SLA", ylim=c(0,1))
...
#plot(area_wp_ms1)
imp = importance(subset(area_wp_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
df = data.frame(variable=names(imp), impvalue=matrix(imp))
barplot(df$impvalue, names.arg=df$variable, las=2, ylab="Importance", cex.axis=1.3, cex.lab=axlab, cex.names = axtitle, main="Leaf area", ylim=c(0,1))
...
#plot(d2f_np_ms1)
imp = importance(subset(d2f_np_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
df = data.frame(variable=names(imp), impvalue=matrix(imp))
...
#plot(sl_np_ms1)
imp = importance(subset(sl_np_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
df = data.frame(variable=names(imp), impvalue=matrix(imp))
barplot(df$impvalue, names.arg=df$variable, las=2, ylab="Importance", cex.axis=1.3, cex.lab=axlab, cex.names = axtitle, main="Stem length", ylim=c(0,1))
...
#plot(SLA_np_ms1)
imp = importance(subset(SLA_np_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
df = data.frame(variable=names(imp), impvalue=matrix(imp))
barplot(df$impvalue, names.arg=df$variable, las=2, ylab="Importance", cex.axis=1.3, cex.lab=axlab, cex.names = axtitle, main="SLA", ylim=c(0,1))
...
#plot(area_np_ms1)
imp = importance(subset(area_np_ms1,delta <= AIC_diff))
imp = imp[imp>=0.1]
df = data.frame(variable=names(imp), impvalue=matrix(imp))
